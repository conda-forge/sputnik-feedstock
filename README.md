About sputnik-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sputnik-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1957&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sputnik-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sputnik` can be installed with `conda`:
...
```
mamba install sputnik
```

It is possible to list all of the versions of `sputnik` available on your platform with `conda`:
...
```
mamba search sputnik --channel conda-forge
```
...
mamba repoquery search sputnik --channel conda-forge

# List packages depending on `sputnik`:
mamba repoquery whoneeds sputnik --channel conda-forge

# List dependencies of `sputnik`:
mamba repoquery depends sputnik --channel conda-forge
```
